        ...
        <div className="hidden md:flex items-center gap-1">
          {navLinks.map((link) => (
            <a
              ...
              className="text-sm text-white/80 hover:text-white px-4 py-1.5 rounded-full border border-transparent hover:bg-white/10 hover:border-white/20 hover:backdrop-blur-sm transition-all duration-200"
            >
              {link}
            </a>
          ))}
